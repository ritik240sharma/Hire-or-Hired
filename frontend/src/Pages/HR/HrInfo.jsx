      ...
      <div className='bg-white pl-[300px] p-10'>
          <div className='flex flex-row mb-12'>
             <div className='mr-[220px]'>
                <img src="public\images\titlelogo.png" className='w-20 h-20 rounded-full'/>
             ...
             <div className=''>
                <video className='w-[350px] h-[200px] rounded-lg bg-slate-800' controls src='public\images\vid.mp4'/>
